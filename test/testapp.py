...
''' 
SpotifyOAuth(client_id, client_secret, redirect_uri, state, scope, cache_path, requests_timeout, username)
create_spotify_oauth uses spotipy's SpotifyOAuth() function to create a SpotifyOAuth object.
scope tells the program what information should be capable of being retrieved from spotify
